import numpy as np
from pupper.HardwareConfig import (
    MICROS_PER_RAD,
    NEUTRAL_ANGLE_DEGREES,
    PS4_COLOR,
    PS4_ARM_COLOR,
    PS4_DEACTIVATED_COLOR,
    PS4_RECORD_COLOR,
)
...
class Configuration:
    def __init__(self):
        ...
        self.ps4_record_color = PS4_RECORD_COLOR
        self.ps4_arm_color = PS4_ARM_COLOR
        ...
        self.arm_x_factor = 0.005
        self.arm_y_factor = 0.005
        self.arm_z_factor = 0.005
        self.arm_dt = .1
